...
public class Main {
    ...
    public static boolean removeTodoList(Integer number) {
        if (isSelctedTodoNotValid(number)) return false;
    ...
    private static boolean isSelctedTodoNotValid(Integer number) {
        if (number <= 0) {
            return true;
        }
    ...
    public static boolean editTodoList(Integer number, String nweTodo) {
        if (isSelctedTodoNotValid(number)) {
            return false;
        }
        String newTodo = todos[number-1];
